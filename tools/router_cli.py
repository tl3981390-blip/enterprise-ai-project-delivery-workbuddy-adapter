...
from harness_skill_snapshot import fingerprint, load_snapshot  # noqa: E402
...
def main(argv: list[str]) -> int:
    ...
    payload["snapshot_fingerprint_sha256"] = fingerprint(snapshot)
    payload["snapshot_session_id"] = snapshot.session_id
